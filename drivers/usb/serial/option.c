...
/* LONGSUNG PRODUCTS*/ //lqm add,2012-06-06
#define LONGSUNG_VENDOR_ID			0x1C9E
#define LONGSUNG_PRODUCR_U6100		0x9603
...
static const struct usb_device_id option_ids[] = {
	...
	{USB_DEVICE(0x12d1,0x1003) },	/*huawei wcdma 3g modem,song add,2012-05-11*/
	{USB_DEVICE(LONGSUNG_VENDOR_ID,LONGSUNG_PRODUCR_U6100)},/*lqm add,2012-06-06*/
	{ } /* Terminating entry */
};
